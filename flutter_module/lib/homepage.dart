...
import 'package:flutter_module/secondpage.dart';
...
class _HomePageState extends State<HomePage> {
  static const nativeChannel = MethodChannel('com.example.flutter/native');
  static const flutterChannel = MethodChannel('com.example.flutter/flutter');
  final _nameController = TextEditingController();
  late Map<dynamic, dynamic> params;
